    ...
    return (
        <div id="contacts" className='Contacts-Container'>
            <div className='Contacts-Extra-Container'>
                ...
                <iframe title='Map' src={data.contacts.mapUrl} width="600" height="450" style={{border: "0"}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                    {/* Google map */}
                {/* </div>  */}
            </div>
