const dataRu = {
    ...
    offices: 
            {
                secondFloor: {
                    ...
                    area_7_8: {
                        ...
                        statusTitle: ["А", "Р", "Е", "Н", "Д", "О", "В", "А", "Н", "Н", "Ы", "Й"],
                        tooltipStatusTitle: "АРЕНДОВАННЫЙ",
                        advantages: ["площадь 39,5 кв.м", "2 этаж",
                        "кондиционер",
                        "высота потолков от 3 метров",
                  ...
                  area_9: {
                        ...
                        statusTitle: ["А", "Р", "Е", "Н", "Д", "О", "В", "А", "Н", "Н", "Ы", "Й"],
                        tooltipStatusTitle: "АРЕНДОВАННЫЙ",
                        advantages: ["площадь 21,1 кв.м", "2 этаж",
                        "кондиционер",
                        "высота потолков от 3 метров",
                        "большие окна / светлые кабинеты", 
                        "базовая офисная отделка / отделка после арендатора",
                  ...
                  area_10: {
                        ...
                        statusTitle: ["А", "Р", "Е", "Н", "Д", "О", "В", "А", "Н", "Н", "Ы", "Й"],
                        tooltipStatusTitle: "АРЕНДОВАННЫЙ",
                        advantages: ["площадь 22,0 кв.м", "2 этаж",
                        "возможна аренда с мебелью",
                        "высота потолков от 3 метров",
                        "большие окна / светлые кабинеты", 
                        "базовая офисная отделка / отделка после арендатора",
                        "покрытие пола – ламинат",
                  ...
                  area_16: {
                        ...
                        statusTitle: ["А", "Р", "Е", "Н", "Д", "О", "В", "А", "Н", "Н", "Ы", "Й"],
                        tooltipStatusTitle: "АРЕНДОВАННЫЙ",
                        advantages: ["площадь 21,2 кв.м", "2 этаж",
                        "кондиционер",
                        "возможна аренда с мебелью",
                        "высота потолков от 3 метров",
                        "большие окна / светлые кабинеты", 
                  ...
                  area_17: {
                        ...
                        statusTitle: ["А", "Р", "Е", "Н", "Д", "О", "В", "А", "Н", "Н", "Ы", "Й"],
                        tooltipStatusTitle: "АРЕНДОВАННЫЙ",
                        advantages: ["площадь 19,6 кв.м", "2 этаж",
                        "кондиционер",
                        "высота потолков от 3 метров",
                        "большие окна / светлые кабинеты", 
                        "базовая офисная отделка / отделка после арендатора",
                  ...
                  area_18: {
                        ...
                        statusTitle: ["А", "Р", "Е", "Н", "Д", "О", "В", "А", "Н", "Н", "Ы", "Й"],
                        tooltipStatusTitle: "АРЕНДОВАННЫЙ",
                        advantages: ["площадь 21,0 кв.м", "2 этаж",
                        "высота потолков от 3 метров",
                        "большие окна / светлые кабинеты", 
                        "базовая офисная отделка / отделка после арендатора",
                        "покрытие пола – линолеум",
                  ...
                  area_21: {
                        ...
                        statusTitle: ["А", "Р", "Е", "Н", "Д", "О", "В", "А", "Н", "Н", "Ы", "Й"],
                        tooltipStatusTitle: "АРЕНДОВАННЫЙ",
                        advantages: ["площадь 22,9 кв.м", "2 этаж",
                        "возможна аренды с мебелью",
                        "высота потолков от 3 метров",
                        "большие окна / светлые кабинеты", 
                        "базовая офисная отделка / отделка после арендатора",
                        "покрытие пола – линолеум",
                ...
                fourthFloor: {
                        ...
                        backLinkText: "Вернуться на четвертый этаж",
                        details: {
                                title: "ОФИС (каб. № 1-18)",
    ...
    contacts: 
            ...
            mapUrl: "https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d2645.9653494392!2d35.05036947628135!3d48.45719437128052!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNDjCsDI3JzI1LjkiTiAzNcKwMDMnMTAuNiJF!5e0!3m2!1sru!2sua!4v1710329554101!5m2!1sru!2sua",
//                 address: 
